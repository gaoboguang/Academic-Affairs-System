...
def _build_shandong_stage_b_payloads(year: int) -> list[ProvinceVolunteerRulePayload]:
    rows = [
        ...
        ("art", "本科批", 30, 96, "专业", "major_parallel", None, "山东艺术类本科批当前按省统考综合分和专业平行志愿基线解释；校考、省际联考和院校特殊原则需人工复核。"),
        ("art", "艺术类本科批统考", 31, 96, "专业", "major_parallel", None, "山东艺术类本科批统考按“专业（专业类）+学校”平行志愿基线解释，最多 96 个志愿。"),
        ("art", "专科批", 32, 96, "专业", "major_parallel", None, "山东艺术类专科批当前按省统考综合分和专业平行志愿基线解释。"),
        ("art", "艺术类专科批", 33, 96, "专业", "major_parallel", None, "山东艺术类专科批当前按专业平行志愿基线解释，最多 96 个志愿。"),
        ("art", "常规批", 34, 96, "专业", "major_parallel", None, "山东艺术类常规批当前按专业平行志愿基线解释，类别限制需人工复核。"),
