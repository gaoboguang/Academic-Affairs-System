...
DEFAULT_SOURCE_DOCUMENT_SEEDS = (
    GaokaoSourceDocumentSeed(
        ...
        url="https://www.sdzk.cn/NewsInfo.aspx?NewsID=5794",
        official_org="山东省教育招生考试院",
        source_registry_code="sdzk",
        published_at=date(2022, 6, 26),
        parser_name="shandong_score_rank_segment",
        note="E6 补齐 2022 夏季高考一分一段，用于历史分数到位次换算。",
    ),
    GaokaoSourceDocumentSeed(
        province="山东",
        year=2021,
        ...
        url="https://www.sdzk.cn/NewsInfo.aspx?NewsID=5458",
        official_org="山东省教育招生考试院",
        source_registry_code="sdzk",
        published_at=date(2021, 6, 25),
        parser_name="shandong_score_rank_segment",
        note="E6 补齐 2021 夏季高考一分一段，用于历史分数到位次换算。",
    ),
    GaokaoSourceDocumentSeed(
        province="山东",
        year=2020,
        ...
        url="https://www.sdzk.cn/NewsInfo.aspx?NewsID=4938",
        official_org="山东省教育招生考试院",
        source_registry_code="sdzk",
        published_at=date(2020, 7, 26),
        parser_name="shandong_score_rank_segment",
        note="E6 补齐 2020 夏季高考一分一段，用于历史分数到位次换算。",
    ),
    GaokaoSourceDocumentSeed(
        province="山东",
        year=2025,
    ...
    GaokaoSourceDocumentSeed(
        ...
        title="山东省2022年夏季高考各类别分数线",
        url="https://www.sdzk.cn/NewsInfo.aspx?NewsID=5788",
        official_org="山东省教育招生考试院",
        source_registry_code="sdzk",
        published_at=date(2022, 6, 25),
        parser_name="shandong_score_line",
        note="E6 补齐 2022 夏季高考各类别分数线；结构化行按官方图片人工校对。",
    ),
    GaokaoSourceDocumentSeed(
        province="山东",
        year=2021,
        source_type="score_line",
        title="山东省2021年夏季高考各类别分数线",
        url="https://www.sdzk.cn/NewsInfo.aspx?NewsID=5460",
        official_org="山东省教育招生考试院",
        source_registry_code="sdzk",
        published_at=date(2021, 6, 25),
        parser_name="shandong_score_line",
        note="E6 补齐 2021 夏季高考各类别分数线；结构化行按官方图片人工校对。",
    ),
    GaokaoSourceDocumentSeed(
        province="山东",
        year=2020,
        source_type="score_line",
        title="山东省2020年夏季高考各类别分数线",
        url="https://www.sdzk.cn/NewsInfo.aspx?NewsID=4941",
        official_org="山东省教育招生考试院",
        source_registry_code="sdzk",
        published_at=date(2020, 7, 26),
        parser_name="shandong_score_line",
        note="E6 补齐 2020 夏季高考各类别分数线；结构化行按官方图片人工校对。",
    ),
    GaokaoSourceDocumentSeed(
        province="山东",
        year=2025,
