...
MATERIAL_LABELS = {
    ...
    "art_culture_composite_rule": "艺术类文化控制线和综合分规则",
    "art_chapter_restrictions": "艺术类院校章程限制",
    "sports_test_score": "体育专业测试成绩",
    "sports_culture_composite_rule": "体育类文化线、专业线和综合分规则",
    "sports_chapter_restrictions": "体育类院校章程和兼报限制",
    "early_batch_physical_political_review": "提前批体检、面试、政审或背景调查材料",
    "early_batch_chapter_limits": "提前批院校章程限制",
    "early_b_service_contract": "提前批 B 类定向协议和服务约束材料",
    "special_type_application_review": "特殊类型报名、资格审核和公示材料",
    "special_type_chapter_limits": "特殊类型高校章程和测试限制",
    "athlete_level_certificate": "体育单招运动员技术等级证书",
    "sports_single_exam_arrangement": "体育单招文化考试和体育专项考试安排",
    "sports_single_college_chapter": "体育单招院校简章和招生项目",
    "high_level_athlete_level": "高水平运动队运动员等级材料",
    "high_level_qualification_review": "高水平运动队资格审查和高校测试安排",
    "high_level_college_chapter": "高水平运动队高校简章和文化成绩要求",
}
...
D2_PATHWAY_RULE_SEEDS: tuple[PathwayRuleSeed, ...] = (
    ...
    PathwayRuleSeed(
        "summer_general_early_a",
        "d7_early_a_accept_early_batch",
        "提前批 A 类报考意向确认",
        "hard_gate",
        "required",
        {"type": "boolean_is", "field": "accept_early_batch", "value": True},
        "提前批 A 类需先确认学生和家庭接受提前批报名、录取和后续约束。",
        "shandong_2025_admission_policy_reference",
    ),
    PathwayRuleSeed(
        "summer_general_early_a",
        "d7_early_a_physical_political_material",
        "提前批 A 类体检政审材料",
        "material_required",
        "review",
        {"type": "material_present", "key": "early_batch_physical_political_review"},
        "补充体检、面试、政审、体能测试或背景调查材料；军警、招飞、航海、消防等方向必须人工复核。",
        "shandong_2025_admission_policy_reference",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
        "summer_general_early_a",
        "d7_early_a_chapter_limits",
        "提前批 A 类章程限制核验",
        "material_required",
        "review",
        {"type": "material_present", "key": "early_batch_chapter_limits"},
        "逐校核对单科成绩、语种、身高、视力、色觉、体检结论、选科和专业备注等章程限制。",
        "shandong_2026_flight_tech",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
    ...
    PathwayRuleSeed(
        "summer_general_early_b",
        "d7_early_b_accept_early_batch",
        "提前批 B 类报考意向确认",
        "hard_gate",
        "required",
        {"type": "boolean_is", "field": "accept_early_batch", "value": True},
        "提前批 B 类需先确认学生和家庭接受提前批报名、录取和定向服务等约束。",
        "shandong_2025_admission_policy_reference",
    ),
    PathwayRuleSeed(
        "summer_general_early_b",
        "d7_early_b_service_contract_material",
        "提前批 B 类定向协议材料",
        "material_required",
        "review",
        {"type": "material_present", "key": "early_b_service_contract"},
        "补充公费师范、省属公费生、定向就业等协议材料，核对签约流程、服务地、服务年限和违约责任。",
        "shandong_2025_admission_policy_reference",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
        "summer_general_early_b",
        "d7_early_b_chapter_limits",
        "提前批 B 类章程限制核验",
        "material_required",
        "review",
        {"type": "material_present", "key": "early_batch_chapter_limits"},
        "逐校核对提前批 B 类专业的单科、语种、体检、面试、身高、视力和服务承诺等限制。",
        "shandong_2025_admission_policy_reference",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
    ...
    PathwayRuleSeed(
        "summer_special_type",
        "d7_special_type_application_review",
        "特殊类型报名审核和公示",
        "material_required",
        "review",
        {"type": "material_present", "key": "special_type_application_review"},
        "补充强基计划、高校专项等路径的报名平台记录、资格审核、公示名单、校测或面试安排。",
        "moe_2026_special_type",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
        "summer_special_type",
        "d7_special_type_chapter_limits",
        "特殊类型高校章程和测试限制",
        "material_required",
        "review",
        {"type": "material_present", "key": "special_type_chapter_limits"},
        "逐校核对高校章程、测试方式、单科成绩、语种、体检、专业限制和公示结果，不得与普通类常规批混用。",
        "moe_2026_special_type",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
    ...
    PathwayRuleSeed(
        "art_undergrad",
        "d7_art_undergrad_culture_composite",
        "艺术本科文化线和综合分规则",
        "material_required",
        "required",
        {"type": "material_present", "key": "art_culture_composite_rule"},
        "补充艺术类本科对应类别的文化控制线、专业成绩折算、综合分规则和院校录取原则。",
        "shandong_2026_art_policy",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
        "art_undergrad",
        "d7_art_undergrad_chapter_restrictions",
        "艺术本科章程限制复核",
        "material_required",
        "review",
        {"type": "material_present", "key": "art_chapter_restrictions"},
        "逐校核对身高、色觉、视力、单科成绩、语种、校考合格和专业备注等章程限制。",
        "shandong_2026_art_policy",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
        "art_undergrad",
        "d7_art_undergrad_concurrent_limit",
        "艺术本科同批次兼报边界",
        "manual_check",
        "review",
        {"type": "manual_review"},
        "艺术类、普通类和体育类同批次兼报限制需按当年政策与志愿填报系统逐项核对。",
        "shandong_2026_art_policy",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
    ...
    PathwayRuleSeed(
        ...
        "required",
        {"type": "material_present", "key": "art_exam_score"},
        "补充艺术专科对应类别的统考、校考或省际联考成绩，并核对文化控制线。",
        "shandong_2026_art_policy",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
        "art_junior",
        "d7_art_junior_chapter_restrictions",
        "艺术专科章程限制复核",
        "material_required",
        "review",
        {"type": "material_present", "key": "art_chapter_restrictions"},
        "逐校核对艺术专科录取原则、综合分、身高、色觉、单科成绩、语种和专业备注。",
        "shandong_2026_art_policy",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
        "art_junior",
        "d7_art_junior_concurrent_limit",
        "艺术专科同批次兼报边界",
        "manual_check",
        "review",
        {"type": "manual_review"},
        "艺术类专科与普通类、体育类同批次兼报边界需按当年志愿填报规则人工复核。",
        "shandong_2026_art_policy",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
    ...
    PathwayRuleSeed(
        "sports_regular",
        "d7_sports_regular_culture_composite",
        "体育常规批文化线和综合分规则",
        "material_required",
        "required",
        {"type": "material_present", "key": "sports_culture_composite_rule"},
        "补充体育类一段/二段控制线、体育专业成绩、文化成绩和综合分规则后再初筛。",
        "shandong_2026_sports_regular",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
        "sports_regular",
        "d7_sports_regular_chapter_restrictions",
        "体育常规批章程和兼报限制",
        "material_required",
        "review",
        {"type": "material_present", "key": "sports_chapter_restrictions"},
        "逐校核对体育类专业章程、体检要求、普通类/艺术类同批次兼报限制和专业备注。",
        "shandong_2026_sports_regular",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
        "sports_regular",
        "d7_sports_regular_concurrent_limit",
        "体育常规批同批次兼报边界",
        "manual_check",
        "review",
        {"type": "manual_review"},
        "体育类常规批与普通类、艺术类同批次兼报限制需按当年志愿填报规则人工复核。",
        "shandong_2026_sports_regular",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
    ...
    PathwayRuleSeed(
        "sports_single_exam",
        "d7_sports_single_candidate_scope",
        "体育单招专项身份确认",
        "hard_gate",
        "required",
        {
            ...
            "items": [
                {"type": "field_in", "field": "candidate_type", "values": ["sports", "体育类"]},
                {"type": "field_in", "field": "exam_type", "values": ["sports_single_exam", "体育单招"]},
                {"type": "field_present", "field": "sports_track"},
            ],
        },
        "体育单招需先确认体育类身份、专项方向或体育单招考试类型，不能与体育类常规批混用。",
        "shandong_2026_sports_single_exam",
    ),
    PathwayRuleSeed(
        "sports_single_exam",
    ...
    PathwayRuleSeed(
        "sports_single_exam",
        "d7_sports_single_exam_arrangement",
        "体育单招文化和专项考试安排",
        "material_required",
        "required",
        {"type": "material_present", "key": "sports_single_exam_arrangement"},
        "补充体育单招报名系统、文化考试、体育专项考试、缴费和考试时间安排。",
        "sport_2026_sports_single_exam_management",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
        "sports_single_exam",
        "d7_sports_single_college_chapter",
        "体育单招院校简章和招生项目",
        "material_required",
        "review",
        {"type": "material_present", "key": "sports_single_college_chapter"},
        "逐校核对体育单招院校简章、招生项目、报名条件、计划、专项测试和录取规则。",
        "sport_2026_sports_single_exam_management",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
    ...
    PathwayRuleSeed(
        ...
        "required",
        {
            ...
            "items": [
                {"type": "field_in", "field": "candidate_type", "values": ["sports", "体育类"]},
                {"type": "field_in", "field": "exam_type", "values": ["high_level_sports", "高水平运动队"]},
                {"type": "field_present", "field": "sports_track"},
            ],
        },
        "高水平运动队需先确认体育专项方向、考试类型或体育类身份，不能与体育类常规批或体育单招混用。",
        "shandong_2026_high_level_sports",
    ),
    PathwayRuleSeed(
        "high_level_sports",
    ...
    PathwayRuleSeed(
        "high_level_sports",
        "d7_high_level_qualification_review",
        "高水平运动队资格审查和高校测试",
        "material_required",
        "required",
        {"type": "material_present", "key": "high_level_qualification_review"},
        "补充高水平运动队资格审查、高校测试、公示、项目一致性和报名材料。",
        "shandong_2026_high_level_sports",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
        "high_level_sports",
        "d7_high_level_college_chapter",
        "高水平运动队高校简章和文化成绩要求",
        "material_required",
        "review",
        {"type": "material_present", "key": "high_level_college_chapter"},
        "逐校核对高水平运动队招生项目、简章、文化成绩、单科语种、专业测试和录取办法。",
        "moe_2026_special_type",
        manual_review_required=True,
    ),
    PathwayRuleSeed(
