...
上述 2025 来源已完成附件级登记与导入：

- 艺术类本科批 6 个官方 XLS 附件，raw 3403 条，应用侧可靠匹配 2869 条。
- 体育类常规批 1 个官方 XLS 附件，raw 393 条，应用侧可靠匹配 385 条。
- 春季高考本科批 1 个官方 XLS 附件，raw 340 条，应用侧可靠匹配 340 条。
